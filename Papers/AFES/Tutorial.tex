In this section we introduce the usage of \texttt{AFES} by the use of examples. The AFES
...
\section{Solving a PDE} \label{sec:Solver}
    ...
    In the example that follows we will demonstrate the use of AFES through two
    ...
    strength of AFES. This method uses the definition of subclasses to define
...
\subsection{Heat Equation} \label{sse:Heat}
    ...
    Just as in the definition of the PDE \texttt{AFES} requires certain things
    ...
    the \texttt{Problem} class provided by AFES.
...
\subsection{Navier-Stokes Equations} \label{sse:NSE}
    ...
    \lstinputlisting[firstline=6,lastline=16,
        caption={Importing \texttt{AFES} and problem specific parameter definitions for
                flow around a cylinder.}
    ]{Cylinder.py}
    \lstinputlisting[firstline=52, lastline=93, caption={Initialization of
    ...
    \lstinputlisting[firstline=18,lastline=28, label={lst:ICExpNSE},
    ...
    \lstinputlisting[firstline=29,lastline=50, label={lst:SubDomainsNSE},
    ...
    oriented adaptivity.
    \lstinputlisting[firstline=137,lastline=147, label={lst:Functional},
    ...
    \lstinputlisting[firstline=5,lastline=17,
        caption={Importing \texttt{AFES} and initializing the NSE
    ...
    \lstinputlisting[firstline=19,lastline=69,
        caption={Defining the \texttt{strong\_residual},
                \texttt{stabilization\_parameters}, and
                \texttt{weak\_residual}.}
    ]{NSE.py}
