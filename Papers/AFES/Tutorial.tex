...
\subsubsection{Advection-Reaction-Diffusion Equation} \label{sss:ADR}
    ...
    center square removed. That is we take the outer square to be $\Omega_1 =
    [0,1]^2$ and the inner square to be $\Omega_2 = [0.48,0.52]^2$ and the
    resulting domain $\Omega$ is given by
    \begin{equation}
    ...
    \Omega_2$ is the boundary of $\Omega_2$.

    With the domain, $\Omega$, and its boundary, $\partial \Omega$, given we
