...
\mathbf{u}_t)) \; (\nabla \cdot (h \mathbf{v}) )\: \mathrm{dx} \\ 
		...
		\begin{equation}
			...
			\subsection{Solitary wave solution}
				Before using our finite element code, one of the first step is to assess it, using the numerically approximate solitary solution of the Peregrine system:
				\begin{figure}
					\includegraphics[height=3cm]{}
					\caption{Solitary solution of the Peregrine system}
				\end{figure}
